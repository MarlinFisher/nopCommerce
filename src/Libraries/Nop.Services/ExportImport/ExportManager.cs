            ...
            using (var inputStream = new MemoryStream(data))
            {
                using (var inputPackage = new ExcelPackage(inputStream))
                {
                    ...
                    var properties = new[]
                    {
                        ...
                        new PropertyByName<ExportProductAttribute>("AttributName", p => p.AttributName),
                    ...
                    foreach (var product in products)
                    {
                        ...
                        manager.WriteCaption(worksheet, SetCaptionStyle, row, ExportProductAttribute.ProducAttributCellOffset);
                        ...
                        foreach (var exportProducAttribut in attributes)
                        {
                            ...
                            manager.WriteToXlsx(worksheet, row, ExportProductAttribute.ProducAttributCellOffset);
                            worksheet.Row(row).OutlineLevel = 1;
                            worksheet.Row(row).Collapsed = true;
                        }
